			...
			<div class="row">
				<div class="col-lg-12">
					<div id="widraw_title" class="section-title">
						<h2
							style="font-size: x-large; font-weight: bold; color: #333333; background-color: #F5f5f5; padding: 10px 15px;">탈퇴
							경고 메시지</h2>


						<svg
							xmlns="<svg xmlns="http://www.w3.org/2000/svg" width="50" height="70" color="red" fill="currentColor" class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16">
                            <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5m.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
                          </svg>
                          
                        <p style="font-size: x-large;">정말 탈퇴하시겠습니까?</p>
                        ...
                        <body>
                            ...
                            <form action="memberOut.do?user_id=${sessionScope.info.user_id}" method="post">
                            	
                                <button type="submit" style="background-color: #ffc107;
                                border: none;
                                border-radius:10px;
                                color: #212529;
                                padding: 6px 12px;
                                ...
                                cursor: pointer;
                                height: 20%;
                                font: 16px Cairo, sans-serif;">탈퇴완료</button>
                            </form>
                            ...
                            <form action="ProductList.do" >
                                ...
                                cursor: pointer;
                                height: 20%;
                                font: 16px Cairo, sans-serif;">탈퇴취소</button>
                            </form>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="img/중고스쿨초록색로고누끼완.png" alt=""></a>
                        </div>
                        <!-- 하단 회사정보 삭제
                        <ul>
