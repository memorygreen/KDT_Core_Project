	...
	<div class="humberger__menu__wrapper">
		...
		<nav class="humberger__menu__nav mobile-menu">
			<ul>
				...
				<li>
					<!-- 반응형웹 --> <!-- 마이페이지 또는 관리자 페이지 --> <c:choose>
						<c:when
							test="${not empty sessionScope.info and sessionScope.info.user_role eq 'A'}">

							<!-- 관리자 페이지로 이동하는 링크 -->
							<a href="AdministratorList.do"> <svg
						...
						<c:when
							test="${not empty sessionScope.info and sessionScope.info.user_role eq 'u'}">
							<!-- 마이페이지로 이동하는 링크 -->
							<a href="myPage.do"> <svg xmlns="http://www.w3.org/2000/svg"
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						...
						<c:if
							test="${not empty sessionScope.info  and sessionScope.info.user_status eq '활동중'}">
					...
					<div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
						<div class="featured__item">
							...
							<div class="featured__item__text">
								<h6
									style="font-weight: bold; display: inline-block; padding: 5px 10px; 
									...
									${prod.prod_status}</h6>
								<!-- 상품 판매 상태(거래완료일 때에는 빨간색으로 표시 (삼항연산자 사용) -->
								<h6>
									<a href="ProductContent.do?prod_idx=${prod.prod_idx}">${prod.prod_name}</a>
								</h6>
								...
								<!-- 상품 게시 일자 -->
								</br> <span style="font-size: 13px;">조회수 ${prod.prod_views}</span> </br>
							</div>
						</div>
					</div>
				</c:forEach>
			...
			<div class="row">
					...
					<div class="latest-product__text">
						...
						<div class="latest-product__slider owl-carousel">
							...
							<div class="latest-prdouct__slider__item">
								<c:forEach items="${prod_views_list}" var="prod_views" begin="0"
									end="2" varStatus="i">
									<a href="#" class="latest-product__item">
										...
										<div class="latest-product__item__text">
											<h6>
												<a href="ProductContent.do?prod_idx=${prod_views.prod_idx}">${prod_views.prod_name}</a>
											</h6>
							...
							<!-- 4~6번째 (3번 ~5번 인덱스)반복 -->
							<div class="latest-prdouct__slider__item">
								<c:forEach items="${prod_views_list}" var="prod_views" begin="3"
									end="5" varStatus="i">
									<a href="#" class="latest-product__item">
										<div class="latest-product__item__pic">
											<img src="img/latest-product/lp-1.jpg" alt="">
				...
				<div class="col-lg-4 col-md-6">
					<div class="latest-product__text">
						...
						<div class="latest-product__slider owl-carousel">
							<div class="latest-prdouct__slider__item">
								<c:forEach items="${prod_lowest_price_list}" var="prod_lowest"
									begin="0" end="2" varStatus="i">
									<!-- 1~3번째 (0번 ~2번 인덱스)반복 -->
									<a href="#" class="latest-product__item">
										<div class="latest-product__item__pic">
											<img src="img/latest-product/lp-1.jpg" alt="">
					...
					<div class="latest-product__text">
						...
						<div class="latest-product__slider owl-carousel">
							<div class="latest-prdouct__slider__item">
								...
								<c:forEach items="${prod_reply_list}" var="prod_reply" begin="0"
									end="2" varStatus="i">
									<!-- 4~6번째 (3번 ~5번 인덱스)반복 -->
									<a href="#" class="latest-product__item">
										<div class="latest-product__item__pic">
										...
										<div class="latest-product__item__text">
											<h6>
												<a href="ProductContent.do?prod_idx=${prod_reply.prod_idx}">${prod_reply.prod_name}</a>
											</h6>
											<!-- 첫번째 상품 제목 -->
											<span>${prod_reply.prod_price}</span>
											<!-- 첫번째 상품 가격 -->
										</div>
									</a>
								</c:forEach>
							...
							<div class="latest-prdouct__slider__item">
								<c:forEach items="${prod_reply_list}" var="prod_reply" begin="3"
									end="5" varStatus="i">
									<!-- 4~6번째 (3번 ~5번 인덱스)반복 -->
									<a href="#" class="latest-product__item">
										<div class="latest-product__item__pic">
